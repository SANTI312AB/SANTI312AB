...
Ingeniero en Informática con más de 3 años de experiencia en desarrollo Back-End y gestión de bases de datos relacionales[cite: 1]. Especializado en el diseño e implementación de APIs con **Node.js (NestJS)** y **PHP (Symfony)**, así como en la optimización de bases de datos **SQL** y procesos **ETL**[cite: 1].

---

### 🛠️ Tecnologías y Herramientas

- **Lenguajes & Frameworks:** Node.js (NestJS), PHP (Symfony), C# (.NET / WinForms), TypeScript, SQL[cite: 1]
- **Bases de Datos & Datos:** Oracle, SQL Server, SQLite, Procesos ETL (Pentaho Data Analytics), Data Warehouse, Migraciones de Datos[cite: 1]
- **Herramientas & Despliegue:** Git, Docker, WordPress[cite: 1]
